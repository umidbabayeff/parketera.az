      ...
      <div className="max-w-[1600px] px-8 md:px-12 mx-auto mt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="text-left">
            <span className="text-accent-gold uppercase tracking-[0.4em] text-[10px] font-bold mb-6 block border-l-2 border-accent-gold pl-4">{t('contact.title')}</span>
            <h1 className="text-6xl md:text-[8rem] lg:text-[7rem] font-display text-white mb-20 leading-none">{t('contact.heading')} <br /> <span className="luxury-gradient italic">{t('contact.heading_italic')}</span></h1>
            ...
            <div className="space-y-12 mb-16">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="text-white/40 text-[10px] uppercase tracking-[0.3em] font-bold mb-4">{t('contact.email')}</h4>
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="text-white/40 text-[10px] uppercase tracking-0.3em font-bold mb-4">{t('contact.address')}</h4>
                    <p className="text-xl font-light">{t('contact.address_value')}</p>
                  </div>
                </div>
              </div>
            ...
            <form className="space-y-8 text-left">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="group border-b border-white/10 pb-4 focus-within:border-accent-gold transition-colors">
                  <label className="text-[10px] uppercase tracking-widest text-white/30 block mb-2">{t('contact.name_placeholder')}</label>
                ...
                <div className="group border-b border-white/10 pb-4 focus-within:border-accent-gold transition-colors">
                  <label className="text-[10px] uppercase tracking-widest text-white/30 block mb-2">{t('contact.phone_placeholder')}</label>
              ...
              <div className="group border-b border-white/10 pb-4 focus-within:border-accent-gold transition-colors">
                <label className="text-[10px] uppercase tracking-widest text-white/30 block mb-2">{t('contact.message_placeholder')}</label>
                <textarea className="w-full bg-transparent border-none outline-none text-white text-lg font-light min-h-[120px]" placeholder="..."></textarea>
              </div>
              <button className="btn-primary w-full flex items-center justify-center gap-4 py-6 group">
                <span className="uppercase tracking-[0.2em] text-xs font-bold">{t('contact.send')}</span>
