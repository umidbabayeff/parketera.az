  ...
  return (
    <div className="pt-32 pb-20 bg-bg-dark">
      <div className="max-w-[1600px] px-8 md:px-12 mx-auto">
        <div className="mb-20">
          <span className="text-accent-gold uppercase tracking-[0.4em] text-[10px] font-bold mb-6 block border-l-2 border-accent-gold pl-4">{t('projects.title')}</span>
          <h1 className="text-5xl md:text-7xl font-display leading-tight">{t('projects.heading')} <span className="luxury-gradient italic">{t('projects.heading_italic')}</span></h1>
        </div>
            ...
            >
              ...
              <div className="absolute bottom-10 left-10 z-20">
                <span className="text-accent-gold text-[10px] uppercase tracking-[0.3em] font-bold mb-2 block opacity-0 group-hover:opacity-100 transition-all translate-y-4 group-hover:translate-y-0">
                  {t(`project_cats.${project.category}`, project.category)}
                </span>
